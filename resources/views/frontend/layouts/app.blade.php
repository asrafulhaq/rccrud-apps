...
<div class="wrap-body">
	...
	<header>
		<div class="zerogrid">
			<center><div class="logo"><img src="{{ asset('frontend/images/logo.png') }}"></div></center>
		</div>
	</header>
	<div class="site-title">
		<div class="zerogrid">
			<div class="row">
				<h2 class="t-center">@yield('sub-title', 'Truely the best restaurant in town - The New York Times')</h2>
			</div>
		</div>
	</div>
    <!--//////////////////////////////////////Menu-->
    ...
    <nav class="cmn-tile-nav">
		<ul class="clearfix">
			...
			<li class="colour-6"><a href="{{ route('staff.page') }}">Our Staff</a></li>
